...
| Project Name                           | Description                                                                                        | Datasets                                                                                                                                                        | Start Date | Branch Name       |
| -------------------------------------- | -------------------------------------------------------------------------------------------------- | --------------------------------------------------------------------------------------------------------------------------------------------------------------- | ---------- | ----------------- |
| DC vs Marvel: Battle of the Box Office | [R] Which comic universe is most popular?                                                          |                                                                                                                                                                 |            | project/dc-marvel |
| WSL: Big Four                          | [R] Who are the Big Four of the Women's Super League?[M] Who will win the WSL next season (26/27)? | [25/26](https://fixturedownload.com/results/wsl-2025)[24/25](https://fixturedownload.com/results/wsl-2024)[23/24](https://fixturedownload.com/results/wsl-2023) |            | project/wsl       |
